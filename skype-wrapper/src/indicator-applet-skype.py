...
bus = dbus.SessionBus()
wrapperPath = "/usr/share/skype-wrapper"
...
class SkypeBehaviour:
    ...
    def setPresence(self, presence):
        if not helpers.isMissionControlRunning:
            return
        
        account_manager = bus.get_object('org.freedesktop.Telepathy.AccountManager', '/org/freedesktop/Telepathy/AccountManager')
        accounts = account_manager.Get('org.freedesktop.Telepathy.AccountManager', 'ValidAccounts')
